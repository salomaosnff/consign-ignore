...
module.exports = function(consign, assert) {
  ...
  it('Should ignore files.', function() {
    var ignore_pattern = [/ignored\-file\.js/];
    var instance = consign({ignore: ignore_pattern, verbose: verbose});
      return assert.equal(instance._options.ignore, ignore_pattern);
  });
};
